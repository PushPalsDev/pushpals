...
| `durable_lifecycle`    | Worker-required requests cannot complete without a durable job across queue and HTTP boundaries; claimed requests renew completion leases; expired handoffs reconcile after restart.                                                                                                                                                                                        |
