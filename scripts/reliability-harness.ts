...
const phases: HarnessPhase[] = [
  ...
  },
  {
    ...
    files: [
      ...
      "tests/remotebuddy.worker-container-cleanup.test.ts",
      "tests/remotebuddy.worker-spawn-command.test.ts",
      "tests/remotebuddy.worker-autoscale.test.ts",
      "tests/workerpals.image-preparation-progress.test.ts",
      "tests/workerpals.startup-budget.test.ts",
